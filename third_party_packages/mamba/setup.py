...
# === AJOUT pour détecter CUDA et skip si non présent ===
if CUDA_HOME is None or not Path(CUDA_HOME).joinpath("bin/nvcc").exists():
    print(f"Warning: CUDA_HOME is not set or nvcc not found. Skipping CUDA build.")
...
if not SKIP_CUDA_BUILD:
    ...
    bare_metal_version = Version(torch.version.cuda)
